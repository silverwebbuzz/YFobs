(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~invoice-invoice-options-invoice-options-module~invoice-list-list-module~invoice-view-invoice~2b095416"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppInvoiceViewInvoiceViewPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppInvoiceViewInvoiceViewPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppInvoiceViewInvoiceViewPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "InvoiceViewPage", function () {
      ...
      var InvoiceViewPage = /*#__PURE__*/function () {
        function InvoiceViewPage(plt, socialSharing, apiService, api, route, modelctrl, router, file, fileOpener, printer, datePipe) {
          _classCallCheck(this, InvoiceViewPage);
          ...
          this.datePipe = datePipe; //@Input() InvoiceNumber: any;
        ...
        _createClass(InvoiceViewPage, [{
          ...
          key: "getInvoiceData",
          value: function getInvoiceData(InvoiceId) {
            var _this = this;
            ...
            this.api.Post("invoice/invoiceEdit/" + InvoiceId, body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (res) {
              _this.customer = res.data.selectedCustomer.length >= 1 ? res.data.selectedCustomer[0] : [];
              _this.ItemData = res.data.items.length >= 1 ? res.data.items : [];
              var ActiveBusiness = localStorage.getItem("ActiveBusiness");
              _this.ActiveBusiness = JSON.parse(ActiveBusiness);
              _this.privew = res.data.invoice ? res.data.invoice : '';
              _this.tax = _this.privew.tax ? _this.privew.tax : 0;
              _this.discount = _this.privew.discount ? _this.privew.discount : 0; //this.loadData(this.api.NetworkStatus,this.privew.taxes_id,this.ActiveBusiness.state_id);

              _this.loadData(_this.api.NetworkStatus, _this.privew.taxes_id, _this.ActiveBusiness.state_id, _this.customer.country, _this.customer.state);

              _this.footer_note = _this.privew.footer_note;

              _this.laodCalculation();
          ...
          value: function loadData() {
            ...
            var taxes_id = arguments.length > 1 ? arguments[1] : undefined;
            var state_id = arguments.length > 2 ? arguments[2] : undefined;
            var customer_country_id = arguments.length > 3 ? arguments[3] : undefined;
            var customer_state_id = arguments.length > 4 ? arguments[4] : undefined;
            this.apiService.allApi(refresh).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (res) {
              _this2.state = res.data.state;
              _this2.taxValueList = res.data.taxOptions;

              var taxt_rate = _this2.taxValueList.filter(function (x) {
                return x.id == taxes_id;
              });

              _this2.taxName = taxt_rate.length >= 1 ? taxt_rate[0].name : '';

              var state = _this2.state.filter(function (x) {
                return x.id == state_id;
              });

              _this2.state = state.length >= 1 ? state[0].name : '';
              var customerstate = res.data.state.filter(function (x) {
                return x.id == customer_state_id;
              });
              _this2.customer_state_id = customerstate.length >= 1 ? customerstate[0].name : '';
              var country = res.data.countries.filter(function (x) {
                return x.id == customer_country_id;
              });
              _this2.country = country.length >= 1 ? country[0].name : '';
            }, function (err) {
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      this.plt.ready().then(function () {
                        ...
                        _this3.api.Get("invoice/exportPdf/" + _this3.InvoiceId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["timeout"])(_this3.api.API_TIMEOUT)).subscribe(function (res) {
                          _this3.api.dismissLoading();

                          _this3.socialSharing.share(res['data'].business_name, res['data'].invoice_number, res['data'].link).then(function (data) {})["catch"](function (err) {});
                        }, function (err) {
                          _this3.api.dismissLoading();
          ...
          key: "sharePdf",
          value: function sharePdf(type) {
            var _this4 = this;

            this.api.presentLoading();
            var div = document.getElementById("printable-area");
            dom_to_image__WEBPACK_IMPORTED_MODULE_8___default.a.toPng(div).then(function (dataUrl) {
              var doc = new jspdf__WEBPACK_IMPORTED_MODULE_11__("p", "mm", "a4");
              doc.addImage(dataUrl, 'PNG', 20, 20, 170, 250); //doc.save('MYPdf.pdf');
              ...
              var directory = _this4.file.dataDirectory;

              var toDayDate = _this4.datePipe.transform(new Date(), 'dd-MM-yyyy');

              var fileName = "invoice-" + toDayDate + ".pdf";
              var options = {
                replace: true
              };

              _this4.file.checkFile(directory, fileName).then(function (success) {
                //Writing File to Device
                _this4.file.writeFile(directory, fileName, buffer, options).then(function (success) {
                  _this4.api.dismissLoading();

                  if (type == 'share') {
                    _this4.socialSharing.share('Here is your PDF file', 'Your PDF', _this4.file.dataDirectory + fileName).then(function (data) {// Share after part
                    })["catch"](function (err) {// error
                    });
                  } else {
                    _this4.printer.print(_this4.file.dataDirectory + fileName);
                  }
                ...
                //Writing File to Device
                _this4.file.writeFile(directory, fileName, buffer).then(function (success) {
                  _this4.api.dismissLoading();

                  _this4.fileOpener.open(_this4.file.dataDirectory + fileName, 'application/pdf').then(function () {
      ...
      InvoiceViewPage.ctorParameters = function () {
        return [{
      ...
      InvoiceViewPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-invoice-view',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./invoice-view.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/invoice/view/invoice-view.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./invoice-view.page.scss */
        "./src/app/invoice/view/invoice-view.page.scss"))["default"]]
      })], InvoiceViewPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=default~invoice-invoice-options-invoice-options-module~invoice-list-list-module~invoice-view-invoice~2b095416-es5.js.map