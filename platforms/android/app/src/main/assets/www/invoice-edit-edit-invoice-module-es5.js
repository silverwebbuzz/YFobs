(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["invoice-edit-edit-invoice-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppInvoiceEditEditInvoicePageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppInvoiceEditEditInvoiceRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EditInvoicePageRoutingModule", function () {
      ...
      var _edit_invoice_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./edit-invoice.page */
      ...
      var EditInvoicePageRoutingModule = function EditInvoicePageRoutingModule() {
        _classCallCheck(this, EditInvoicePageRoutingModule);
      };

      EditInvoicePageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppInvoiceEditEditInvoiceModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EditInvoicePageModule", function () {
      ...
      var _edit_invoice_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./edit-invoice-routing.module */
      "./src/app/invoice/edit/edit-invoice-routing.module.ts");
      /* harmony import */


      var _edit_invoice_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./edit-invoice.page */
      "./src/app/invoice/edit/edit-invoice.page.ts");
      /* harmony import */


      var _logisticinfotech_ionic4_datepicker__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var EditInvoicePageModule = function EditInvoicePageModule() {
        _classCallCheck(this, EditInvoicePageModule);
      };

      EditInvoicePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _logisticinfotech_ionic4_datepicker__WEBPACK_IMPORTED_MODULE_7__["Ionic4DatepickerModule"], _edit_invoice_routing_module__WEBPACK_IMPORTED_MODULE_5__["EditInvoicePageRoutingModule"]],
    ...
    /***/
    function srcAppInvoiceEditEditInvoicePageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppInvoiceEditEditInvoicePageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EditInvoicePage", function () {
      ...
      var _create_customer_create_customer_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../create-customer/create-customer.page */
      "./src/app/create-customer/create-customer.page.ts");
      /* harmony import */


      var _preview_preview_invoice_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../preview/preview-invoice.page */
      ...
      var _global_common_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var src_app_create_item_multiple_items_multiple_items_page__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! src/app/create-item/multiple-items/multiple-items.page */
      "./src/app/create-item/multiple-items/multiple-items.page.ts");

      var EditInvoicePage = /*#__PURE__*/function () {
        function EditInvoicePage(modelctrl, navCtrl, statusBar, plt, datepipe, api, route, apiService, router, formBuilder) {
          _classCallCheck(this, EditInvoicePage);
        ...
        _createClass(EditInvoicePage, [{
          ...
          value: function loadData() {
            ...
            this.apiService.allApi(refresh).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (res) {
              _this2.taxValueList = res.data.taxOptions;

              if (refresher) {
                refresher.target.complete();
              }

              _this2.getInvoiceData(_this2.api.NetworkStatus);
            }, function (err) {
          ...
          value: function getInvoiceData() {
            ...
            var refresh = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
            var refresher = arguments.length > 1 ? arguments[1] : undefined;
            var InvoiceId = this.route.snapshot.queryParams.InvoiceId;
            this.api.presentLoading();
            this.apiService.getEditInvoice(InvoiceId, refresh).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (res) {
              _this3.CustomerData = res['data'].selectedCustomer;
              _this3.ItemData = res['data'].items;
              _this3.SelectedInvoice = res['data'].invoice;
              var total = 0;

              _this3.ItemData.forEach(function (x) {
                return total += Number(x.qty);
              });

              _this3.itemqty = total;
              _this3.get_due_limit = _this3.SelectedInvoice.due_limit ? _this3.SelectedInvoice.due_limit : '';
              _this3.GrandTotal = Number(_this3.SelectedInvoice.grand_total);
              _this3.discount = _this3.SelectedInvoice.discount;

              _this3.invoiceForm.patchValue({
                invoice: _this3.SelectedInvoice.title,
                invoiceNo: _this3.SelectedInvoice.number,
                proName: _this3.SelectedInvoice.summary,
                psNo: _this3.SelectedInvoice.poso_number,
                invoiceDate: _this3.SelectedInvoice.date,
                subTotal: _this3.SelectedInvoice.sub_total,
                footer_note: _this3.SelectedInvoice.footer_note.replace(/<[^>]+>/gm, '').replace('&nbsp;', ''),
                amt: Number(_this3.SelectedInvoice.grand_total),
                tax: _this3.SelectedInvoice.taxes_id,
                discount: _this3.SelectedInvoice.discount
              });

              _this3.tax = _this3.SelectedInvoice.tax;

              _this3.laodCalculation();
          ...
          value: function getBusinessDetails() {
            ...
            var refresh = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
            this.apiService.getBusinessDetails(refresh).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (res) {
              var _a;

              _this4.ActiveBusiness = ((_a = res.data) === null || _a === void 0 ? void 0 : _a.length) >= 1 ? res.data[0] : [];
            }, function (err) {
          ...
          key: "businessProfile",
          value: function businessProfile() {
          ...
          key: "fnredirectcustomer",
          value: function fnredirectcustomer(data, index) {
                      ...
                      modal.onDidDismiss().then(function (res) {
                        if (res['data']) {
                          if (res['data'].status == 'update') {
                            _this5.CustomerData.splice(index, 1);

                            _this5.CustomerData.push(res['data']['data']);
                          } else if (res.data) {
                            _this5.CustomerData.push(res['data']['data']);
                          }
                        }
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (res) {
                        if (res.data) {
                          _this6.ItemData = res['data'];

                          _this6.laodCalculation();
                        }
                      });
                      _context3.next = 6;
                      return modal.present();
          ...
          key: "laodCalculation",
          value: function laodCalculation() {
            var tota = 0;
            var totq = 0;

            for (var i = 0; i < this.ItemData.length; i++) {
              if (parseInt(this.ItemData[i].qty)) totq += parseInt(this.ItemData[i].qty);
              this.itemqty = totq;
            }

            for (var i = 0; i < this.ItemData.length; i++) {
              if (parseInt(this.ItemData[i].invoice_item_price)) var tot;
          ...
          key: "loadAmount",
          value: function loadAmount(value, type) {
            if (type == "tax") {
              var taxt_rate = this.taxValueList.filter(function (x) {
                return x.id == value.detail.value;
              });
          ...
          key: "InvoicePreview",
          value: function InvoicePreview(InvoiceId) {
          ...
          value: function InvoiceAdd() {
            ...
            for (var v in this.invoiceForm.controls) {
            ...
            if (this.invoiceForm.valid && this.CustomerData.length > 0 && this.ItemData.length > 0) {
              ...
              this.api.Post("invoice/invoiceAdd", body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (data) {
                if (data.status == 1) {
                  _this7.InvoicePreview(_this7.route.snapshot.queryParams.InvoiceId);
                }
                ...
                _this7.api.presentToastWithOptions("Internal Server Error Please try again after sometime.");
              });
            }
          }
        }, {
      ...
      EditInvoicePage.ctorParameters = function () {
        return [{
      ...
      EditInvoicePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-edit-invoice',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./edit-invoice.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/invoice/edit/edit-invoice.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./edit-invoice.page.scss */
        "./src/app/invoice/edit/edit-invoice.page.scss"))["default"]]
      })], EditInvoicePage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=invoice-edit-edit-invoice-module-es5.js.map