...
/* harmony import */ var _notification_bell_notification_bell_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../notification-bell/notification-bell.page */ "./src/app/notification-bell/notification-bell.page.ts");
...
DashboardPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], ng2_google_charts__WEBPACK_IMPORTED_MODULE_6__["Ng2GoogleChartsModule"],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _global_common_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../global/common_service */ "./src/app/global/common_service.ts");
...
/* harmony import */ var _global_notification_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../global/notification.service */ "./src/app/global/notification.service.ts");
...
let DashboardPage = class DashboardPage {
    constructor(apiService, statusBar, api, plt, navctrl, router, notify) {
    ...
    loadData(refresh = false, refresher) {
        ...
        this.apiService.getDashboardData(refresh).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["timeout"])(this.api.API_TIMEOUT)).subscribe(res => {
            if (res.data) {
                var data = res.data;
...
DashboardPage.propDecorators = {
    ...
    hrzLineChart: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['hrzLineChart',] }],
    barChart: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['barChart',] }]
};
