...
const routes = [
    ...
    {
        path: 'multiple-items',
        loadChildren: () => Promise.all(/*! import() | multiple-items-multiple-items-module */[__webpack_require__.e("default~invoice-add-create-invoice-module~invoice-edit-edit-invoice-module~multiple-items-multiple-i~fa0ad8a1"), __webpack_require__.e("multiple-items-multiple-items-module")]).then(__webpack_require__.bind(null, /*! ./multiple-items/multiple-items.module */ "./src/app/create-item/multiple-items/multiple-items.module.ts")).then(m => m.MultipleItemsPageModule)
    }
];
