(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-angular-autocomplete', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-angular-autocomplete'] = {}, global.ng.core, global.rxjs, global.rxjs.operators, global.ng.common));
    ...
    var NgxAutocompleteService = /** @class */ (function () {
        ...
        /** @nocollapse */ NgxAutocompleteService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function NgxAutocompleteService_Factory() { return new NgxAutocompleteService(); }, token: NgxAutocompleteService, providedIn: "root" });
    ...
    var NgxAutocompleteComponent = /** @class */ (function () {
        function NgxAutocompleteComponent() {
            this.selectedValue = new core.EventEmitter();
            this.data = [];
        ...
        function () {
            var _this = this;
            /** @type {?} */
            var search$ = rxjs.fromEvent(this.searchInput.nativeElement, 'input').pipe(operators.map((/**
             * @param {?} event
             * @return {?}
             */
            function (event) { return event.target.value; })), operators.debounceTime(500), operators.tap((/**
             * @return {?}
             */
            function () { return _this.isSearching = true; })), operators.switchMap((/**
             * @param {?} term
             * @return {?}
             */
            function (term) { return term ? _this.getData(term) : rxjs.of([]); })), operators.tap((/**
             * @return {?}
             */
            function () {
        ...
        NgxAutocompleteComponent.propDecorators = {
            ...
            selectedValue: [{ type: core.Output }]
        };
    ...
    exports.NgxAutocompleteComponent = NgxAutocompleteComponent;
    exports.NgxAutocompleteModule = NgxAutocompleteModule;
    exports.NgxAutocompleteService = NgxAutocompleteService;
    exports.ɵa = DropdownDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-angular-autocomplete.umd.js.map
