(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["customers-list-list-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppCustomersListListPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppCustomersListListPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppCustomersListListPageTs(module, __webpack_exports__, __webpack_require__) {
        ...
        _createClass(ListPage, [{
          ...
          value: function loadData() {
            ...
            this.apiService.getCustomer(refresh).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (res) {
              _this.resp = res;
              _this.customers = res.data ? res.data : [];
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this2.api.Post("Customer/delete", body).subscribe(function (data) {
      ...
      ListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/customers/list/list.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./list.page.scss */
        "./src/app/customers/list/list.page.scss"))["default"]]
      })], ListPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=customers-list-list-module-es5.js.map