(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["customers-edit-edit-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppCustomersEditEditPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppCustomersEditEditPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppCustomersEditEditPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var EditPage = /*#__PURE__*/function () {
        function EditPage(router, navCtrl, statusBar, formBuilder, apiService, api, plt, route) {
        ...
        _createClass(EditPage, [{
          ...
          value: function countryData() {
            ...
            this.apiService.allApi(refresh).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (res) {
              _this.statelist = res.data.state;
              _this.country = res.data.countries;
          ...
          value: function loadData() {
            ...
            var refresh = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
            var refresher = arguments.length > 1 ? arguments[1] : undefined;
            this.apiService.getCustomer(refresh).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (res) {
              if (res.data) {
                var customerdata = res.data.filter(function (x) {
                  return x.id == _this2.reqData.id;
                });
                var customerdetails = customerdata[0];
                _this2.selectedcountry = customerdetails.country;
                _this2.state = _this2.statelist.filter(function (x) {
                  return x.country_id == customerdetails.country;
                });
                _this2.selectedstate = customerdetails.state;
                _this2.currency = _this2.country.filter(function (x) {
                  return x.id == customerdetails.country;
                });
                _this2.country_name = _this2.currency[0].currency_code; // this.selectedcurrency = this.currency[0].currency_code

                _this2.custData.patchValue({
                  ...
                  currency: _this2.currency[0].currency_code + '-' + _this2.currency[0].currency_name
                });
          ...
          value: function ionViewWillEnter() {
            ...
            this.plt.ready().then(function () {
              _this3.countryData(_this3.api.NetworkStatus);
            });
            this.statusBar.show();
            ...
            if (this.custData.valid) {
              ...
              this.api.Post("Customer/add", body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["timeout"])(this.api.API_TIMEOUT)).subscribe(function (data) {
                ...
                if (data.status == 1) {
                  ...
                  _this4.router.navigate(["/customers-list"]);
                }
              }, function (err) {
                _this4.api.dismissLoading();
      ...
      EditPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/customers/edit/edit.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./edit.page.scss */
        "./src/app/customers/edit/edit.page.scss"))["default"]]
      })], EditPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=customers-edit-edit-module-es5.js.map