(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-signin-signin-module"], {
    ...
    function srcAppAuthSigninSigninPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _Services_number_only_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var SigninPage = /*#__PURE__*/function () {
        function SigninPage(formBuilder, numberonly, router, api, apiService, statusBar) {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      for (v in this.SignInForm.controls) {
                    ...
                    case 6:
                      this.attemptRemaining = _context.sent;
                      this.api.dismissLoading();
                      this.router.navigate(['/otp'], {
                        queryParams: {
                          phone: this.SignInForm.value.phone,
                          attemptRemaining: this.attemptRemaining
                        }
                      });
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      return _context2.abrupt("return", new Promise(function (resolve, reject) {
                        _this.api.sendOtp(body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["timeout"])(_this.api.API_TIMEOUT)).subscribe(function (data) {
                          if (data['status'] == 1) {
